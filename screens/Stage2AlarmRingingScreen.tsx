...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#000010', padding: 24, alignItems: 'center', justifyContent: 'flex-start', paddingTop: 50 },
  stageBadge: { backgroundColor: '#1C1C1E', borderRadius: 20, paddingHorizontal: 20, paddingVertical: 6, marginBottom: 24 },
  stageBadgeText: { color: '#FFFFFF', fontSize: 12, fontWeight: '700', letterSpacing: 1.5 },
  time: { color: '#FFFFFF', fontSize: 72, fontWeight: '300', letterSpacing: 2 },
  label: { color: '#8E8E93', fontSize: 16, marginTop: 4 },
  heading: { color: '#8E8E93', fontSize: 12, fontWeight: '600', letterSpacing: 1.5, marginTop: 30, marginBottom: 20, textAlign: 'center' },
  activityCard: { backgroundColor: '#1C1C1E', borderRadius: 20, paddingVertical: 40, paddingHorizontal: 30, alignItems: 'center', width: '80%' },
  activityIcon: { fontSize: 64, marginBottom: 12 },
  activityName: { color: '#FFFFFF', fontSize: 22, fontWeight: '700' },
  description: { color: '#8E8E93', fontSize: 13, textAlign: 'center', marginTop: 24, marginBottom: 28, paddingHorizontal: 20 },
